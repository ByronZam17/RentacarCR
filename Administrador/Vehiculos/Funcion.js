function agregarNuevo() {
    ...
    var precio = document.getElementById("precio").value; // Corregido aquí
    var imagen = document.getElementById("imagen").files[0]; // Obtener el archivo
    ...
    formData.append("precio", precio); // Corregido aquí
...
function mostrarResultadosEnPagina(resultados) {
    var tablaHTML = "<table>";
    tablaHTML += "<tr><th>ID</th><th>Placa</th><th>Marca</th><th>Año</th><th>Tipo</th><th>Precio</th><th>Imagen</th><th>Acciones</th></tr><br>";
